...
class Student extends Person {
    ...
    private Course enrolledCourse; // Association
...
class Classroom {
    ...
    public Classroom(String roomNumber, String courseName, Teacher teacher) {
        ...
        this.course = new Course(courseName, teacher);  // Composition: course is created here
    }

    public void showClassroomInfo() {
        System.out.println("Classroom: " + roomNumber);
        course.showCourseInfo();  // Correct method call
    }
...
public class SchoolSystem {
    public static void main(String[] args) {
        ...
        p1.displayRole();  // Dynamic dispatch
        p2.displayRole();
