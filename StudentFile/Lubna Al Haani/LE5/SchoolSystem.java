...
class Student extends Person {
    ...
    // Added Missing method: enrollCourse(Course course)
...
class Course {
    ...
    // Fixed Error: constructor missing parameter for courseName
    ...
    public void showCourseInfo() {
        // Fixed Error: courseName is possibly null
...
class Classroom {
    ...
    public void showClassroomInfo() {
        ...
        // Added Missing: call method to show course info
        getCourse().showCourseInfo();
    }
...
public class SchoolSystem {
    public static void main(String[] args) {
        ...
        // Added Missing: student enrolls in course from classroom
